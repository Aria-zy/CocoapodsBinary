...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Dollar/Dollar.framework"
  install_dsym "${PODS_ROOT}/Dollar/Dollar.framework.dSYM"
  install_framework "${PODS_ROOT}/Kingfisher/Kingfisher.framework"
  install_dsym "${PODS_ROOT}/Kingfisher/Kingfisher.framework.dSYM"
  install_framework "${PODS_ROOT}/MonkeyKing/MonkeyKing.framework"
  install_dsym "${PODS_ROOT}/MonkeyKing/MonkeyKing.framework.dSYM"
  install_framework "${PODS_ROOT}/Moya/Moya.framework"
  install_dsym "${PODS_ROOT}/Moya/Moya.framework.dSYM"
  install_framework "${PODS_ROOT}/NVActivityIndicatorView/NVActivityIndicatorView.framework"
  install_dsym "${PODS_ROOT}/NVActivityIndicatorView/NVActivityIndicatorView.framework.dSYM"
  install_framework "${PODS_ROOT}/OAuthSwift/OAuthSwift.framework"
  install_dsym "${PODS_ROOT}/OAuthSwift/OAuthSwift.framework.dSYM"
  install_framework "${PODS_ROOT}/ReachabilitySwift/Reachability.framework"
  install_dsym "${PODS_ROOT}/ReachabilitySwift/Reachability.framework.dSYM"
